...
import '../widgets/carrenttype.dart';
import '../widgets/carspecification.dart';
import '../widgets/rentdetail.dart';
...
class CarDetailPage extends StatefulWidget {
  ...
  const CarDetailPage({ Key? key, required this.name, required this.model}) : super(key: key);
                          ...
                          children: [
                            SlideInLeft(
                              child: "${cardetail!['Name']}"
                                  ...
                                  .make()
                                  .shimmer(
                                      primaryColor: const Color.fromARGB(255, 69, 86, 194),
                  ...
                  SlideInLeft(
                    child: Row(
                      children: [
                        ...
                        WidthBox(25),
                        CarSpecCard(
                          spec: cardetail['Seats'],
                          title: "Seat",
                        ),
                        WidthBox(25),
                        CarSpecCard(
                          spec: cardetail['Gears'],
                          title: "Gear",
                        ),
